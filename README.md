...
* [Hugging Face API Example](https://github.com/eniompw/Sentiment_with_BERT/blob/main/HuggingFaceAPI.py)
* [Hugging Face API Reference](https://huggingface.co/docs/api-inference/quicktour#running-inference-with-api-requests)
